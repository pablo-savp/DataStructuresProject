...
strcpy(buffer,comando.c_str());
        ...
        else if(comando.compare("codificar")==0)
        {
            if(*parte2!=NULL&&*parte3==NULL&&*parte4==NULL&&*parte5==NULL&&*parte6==NULL)
            {
              bool funciono;
                //codificar(parte2);
               arch.Codificar(*parte2);
              if(funciono==true){
                cout<<"Secuencias codificadas y almacenadas en el archivo: "<<parte2<<endl;
              }
              else{
                cout<<"No se pueden guardar las secuencias cargadas en el archivo: "<<parte2<<endl;
              }
            }
            else
            {
        ...
        else if(comando.compare("ruta_mas_corta")==0)
        {
         ...
         {
             ruta_mas_corta(parte2, parte3, parte4, parte5,parte6);
         }
        ...
        else if(comando.compare("base_remota")==0)
        {
            if(*parte2!=NULL && *parte3!=NULL && *parte4!=NULL && *parte5==NULL && *parte6==NULL)
            {
              ...
              if(!std::isdigit(par3) || !std::isdigit(par4))
              {
                ...
                base_remota(parte2,parte3,parte4);
...
void Dividir(char direccion[], char* parte1[], char* parte2[], char* parte3[], char* parte4[],char* parte5[], char* parte6[])
{
    ...
    *parte6= aux;
    ...
    //cout<<*parte1<<endl<<*parte2<<endl<<*parte3<<endl<<*parte4<<endl<<*parte5<<endl<<*parte6<<endl;
